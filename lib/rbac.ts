...
/**
 * @deprecated Use hasPermission with Permission.MANAGE_DEPARTMENT_TASKS + context
 */
export async function canManageDepartmentTasks(userProfile: UserWithRoles | null, departmentId: string): Promise<boolean> {
  return hasPermission(userProfile, Permission.MANAGE_DEPARTMENT_TASKS, { departmentId });
}
