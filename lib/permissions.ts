...
export const PermissionDefinitions: Record<Permission, { name: string; description: string; category: string; isOverride?: boolean }> = {
  ...
  [Permission.MANAGE_DEPARTMENT_TASKS]: {
    name: 'Manage Department Tasks',
    description: 'Oversee all tasks within department',
    category: 'Tasks'
  },
  ...
  [Permission.CREATE_KANBAN_CARD]: {
    name: 'Create Kanban Cards',
    description: 'Create new cards on Kanban boards',
    category: 'Kanban'
  },
