...
// DELETE /api/admin/workflows/templates/[id] - Soft delete workflow template
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json({ success: true, message: 'Workflow template deleted successfully' }, { status: 200 });
  } catch (error) {
