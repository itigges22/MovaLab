  ...
  try {
    ...
    switch (type) {
      case 'user': {
        ...
        metrics = await capacityService.getUserCapacityMetrics(userId, weekStartDate);
        break;
      }
      ...
      case 'department': {
        ...
        metrics = await capacityService.getDepartmentCapacityMetrics(id, weekStartDate);
        break;
      }
      ...
      case 'project': {
        ...
        metrics = await capacityService.getProjectCapacityMetrics(id, weekStartDate);
        break;
      }
      ...
      case 'org': {
        ...
        metrics = await capacityService.getOrgCapacityMetrics(weekStartDate);
        break;
      }
