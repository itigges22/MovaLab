...
export async function GET(request: NextRequest) {
  try {
    ...
    const userProfile = await requireAuthAndPermission(Permission.VIEW_OWN_PROFILE, {}, request);
 ...
 * Requires: EDIT_OWN_PROFILE permission
 */
export async function PATCH(request: NextRequest) {
  try {
    // Check authentication and permission
    const userProfile = await requireAuthAndPermission(Permission.EDIT_OWN_PROFILE, {}, request);
